...
const advancedNodes = [
  ...
  { id: '13', title: 'BIOLOGICAL THERMODYNAMICS', img: '/images/extreme_cold_bsvs_202604101950.png', lat: '41.8781', lon: '-87.6298', status: 'COMPUTING', iso: '800', shutter: '1/8000', 
    details: [
      { id: '01.', label: 'CrystallineDeposition', description: 'The accumulation of hoar frost on the subject\'s dermal and fibrous structures indicates a direct phase transition resulting from extreme ambient thermal attenuation. This increased particulate density across the surface demonstrates a significant environmental impact where moisture has undergone immediate solid-state conversion without compromising the underlying structural fatigue boundaries.' },
      { id: '02.', label: 'SubsurfaceScattering', description: 'Photonic penetration of the snow and dermal layers creates internal scattering where light impedance is governed by the structural density of the translucent media. This specular irregularity produces a characteristic glow that reinforces the grounded appearance of the subject within the high-albedo environment while maintaining radiance consistency.' },
      { id: '03.', label: 'DermalCyanosis', description: 'Extreme thermal consequence has initiated peripheral vasoconstriction, leading to an observable shift in the spectral absorption profile of subcutaneous hemoglobin. This attenuation of red light reflection results in a blue-shifted hue which serves as a forensic indicator of severe physiological stress caused by low-temperature exposure and subsequent metabolic deceleration.' }
    ]
  },
  { id: '14', title: 'AERODYNAMIC VELOCITY', img: '/images/aerodynamic_velocity_bsvs_202604102032.png', lat: '41.8781', lon: '-87.6298', status: 'ACTIVE', iso: '800', shutter: '1/8000', 
    details: [
      { id: '01.', label: 'ParticulateAttenuation Fluid Dynamics', description: 'A localized breach of mechanical impedance results in a high-velocity ejecta plume characterized by fluctuating particulate density and significant light attenuation. Micro-specular highlights on spherical fluid droplets contrast with the irregular albedo of solid debris, signaling a violent disruption of the subject\'s structural integrity.' },
      { id: '02.', label: 'SpecularIrregularity', description: 'Prolonged environmental exposure has induced extreme specular irregularity across the dermal surface, manifesting as a complex matrix of localized micro-shadowing and altered albedo. This physical accumulation of particulates and structural weathering prevents cohesive reflection, resulting in a matte texture that confirms the subject\'s material grounding.' },
